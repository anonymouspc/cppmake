...
class SubprocessError(ChildProcessError):
    ...
    stdout   : str
    stderr   : str
    def __init__(self: SubprocessError, command: list[str], exit_code: int, stdout: str, stderr: str, command_printed: bool, stdout_printed: bool, stderr_printed: bool) -> None: ...
