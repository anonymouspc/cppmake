...
def __init__(self: Config) -> None:
    ...
    self._parser.add_argument('--verbose',  action ='store_true',                 default=False,              help=f'print verbose outputs     (default: false)')
    self._parser.add_argument('--build-dir',                                      default='.cppmake',         help=f'specify build dir         (default: .cppmake)')
    self._parser.add_argument('--install-dir',                                    default=system.install_dir, help=f'specify install dir       (default: {system.install_dir})')
