...
class UnitStatusCacher:
    # ========
    def           __init__         (self: UnitStatusCacher, build_dir: path)                                            -> None      : ...
    def           __del__          (self: UnitStatusCacher)                                                             -> None      : ...
    # ========
    async def async_get_export     (self: UnitStatusCacher, code  : Header | Module | Source)                           -> str       : ...
    def             set_export     (self: UnitStatusCacher, code  : Header | Module | Source,  name       : str)        -> None      : ...
    async def async_get_imports    (self: UnitStatusCacher, code  : Header | Module | Source)                           -> list[path]: ...
    def             set_imports    (self: UnitStatusCacher, code  : Header | Module | Source,  imports    : list[path]) -> None      : ...
    async def async_get_includes   (self: UnitStatusCacher, code  : Header | Module | Source)                           -> list[path]: ...
    def             set_includes   (self: UnitStatusCacher, code  : Header | Module | Source,  includes   : list[path]) -> None      : ...
    # ======= =
    def             get_preparsed  (self: UnitStatusCacher, header: Header)                                             -> bool      : ...
    def             set_preparsed  (self: UnitStatusCacher, header: Header,                    preparsed  : bool)       -> None      : ...
    def             get_precompiled(self: UnitStatusCacher, module: Module)                                             -> bool      : ...
    def             set_precompiled(self: UnitStatusCacher, module: Module,                    precompiled: bool)       -> None      : ...
    def             get_compiled   (self: UnitStatusCacher, source: Source)                                             -> bool      : ...
    def             set_compiled   (self: UnitStatusCacher, source: Source,                    compiled   : bool)       -> None      : ...
    def             get_shared     (self: UnitStatusCacher, object: Object)                                             -> bool      : ...
    def             set_shared     (self: UnitStatusCacher, object: Object,                    shared     : bool)       -> None      : ...
    def             get_linked     (self: UnitStatusCacher, object: Object)                                             -> bool      : ...
    def             set_linked     (self: UnitStatusCacher, object: Object,                    linked     : bool)       -> None      : ...
    # ========
...
def __init__(self: UnitStatusCacher, build_dir: path) -> None:
    self._file = join_path(build_dir, '.cache', 'unit_status.json')
    try:
...
def _reflect(self: UnitStatusCacher, variable: typing.Any, depth: int = 2) -> typing.Any:
    if depth >= 0:
        if isinstance(variable, (bool, int, float, str, types.NoneType)):
            return variable
        elif isinstance(variable, tuple):
            return (self._reflect(subvariable, depth - 1) for subvariable in typing.cast(tuple[typing.Any, ...], variable))
        elif isinstance(variable, list):
            return [self._reflect(subvariable, depth - 1) for subvariable in typing.cast(list[typing.Any], variable)]
        elif isinstance(variable, dict):
            return {subkey: self._reflect(subvalue, depth - 1) for subkey, subvalue in typing.cast(dict[typing.Any, typing.Any], variable).items()}
        else:
            return {subkey: self._reflect(subvalue, depth - 1) for subkey, subvalue in vars(typing.cast(object, variable)).items() if not subkey.startswith('_')}
    else:
        return None
