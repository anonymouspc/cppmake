...
clang++ -std=c++26 -I.cppmake/include -I.cppmake/pkg/boost/install/include --precompile -x c++-module import/cppmake.cpp -o .cppmake/import/cppmake.pcm
clang++ -c .cppmake/import/cppmake.pcm -o .cppmake/import/cppmake.o

# lib
mkdir -p .cppmake/lib
clang++ -shared .cppmake/import/cppmake.o .cppmake/pkg/std/install/import/*.o .cppmake/pkg/boost/install/lib/*.a -o .cppmake/lib/cppmake.dylib
