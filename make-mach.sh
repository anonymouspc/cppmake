...
clang++ -std=c++26 -fprebuilt-module-path=.cppmake/import -fprebuilt-module-path=.cppmake/pkg/std/import -fprebuilt-module-path=.cppmake/pkg/boost/import --precompile -x c++-module import/cppmake/system/linux.cpp -o .cppmake/import/cppmake-system.linux.pcm # cppmake:system
