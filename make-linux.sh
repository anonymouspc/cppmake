...
g++ -std=c++26 -fmodules -fmodule-mapper=.cppmake/.mapper -Wno-expose-global-module-tu-local -c import/cppmake/utility/filesystem.cpp -o .cppmake/import/cppmake-utility.filesystem.o
echo "cppmake:utility.templates .cppmake/import/cppmake-utility.templates.gcm" >> ".cppmake/.mapper"
g++ -std=c++26 -fmodules -fmodule-mapper=.cppmake/.mapper -Wno-expose-global-module-tu-local -c import/cppmake/utility/templates.cpp -o .cppmake/import/cppmake-utility.templates.o
...
mkdir -p .cppmake/bin
g++ -std=c++26 -fmodules -fmodule-mapper=.cppmake/.mapper -Wno-expose-global-module-tu-local -c bin/main.cpp -o .cppmake/bin/main.o
